<?php get_header();?>
<div class="solution-header cafm">
...
<div class="solution-testimonial cafm">
...
<div class="solution-features">
  <div class="solution-features-container">
    ...
    <ul class="features cafm">
      ...
      <li>    
        <div class="icon"><i class="fal fa-calendar"></i></div>   
        <h3>Reservations <br>Management</h3>
      ...
      <li>  
        ...
        <h3>Visitor <br>Management</h3>
        <p>Use at reception to register visitors.</p>
      </li>
    </ul>
  </div>
</div>
