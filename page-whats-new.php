...
<div class="whats-new-features">
  ...
  <ul class="features">
    <li style="margin-left: 0;">
      ...
      <p>Rack up your favourite support answers for lightning fast response times.
...
instead of having the team manually write out the same response for each ticket.</p>
    ...
    <li style="margin-right: 0;">
      ...
      <p>Keep track of Engineers using House-on-the-Hill through the mobile UI and quickly see their location through 
...
<div class="solution-features pt2">
  <div class="header">
    ...
    <p>Security is high on the priority list and URL’s generated in email templates are now encrypted using AES256 to prevent URL tampering to access other parts of the system.
    <br>  
  ...
  <ul class="list">
    <li>
      ...
      <h3>Logins</h3>
      <p>More control of user access with separate access for Call and Activities and the option to flag a login as Mobile only access. <br><br>
    ...
    <li>
      ...
      You can now set up a routine to archive records daily. <br>
