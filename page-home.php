...
<div class="home">
  <div class="header">
    <div class="container">  
      <div class="text">  
        <h1>Made to measure <br>service desk software for<img src="https://hoth.local/wp-content/themes/twentytwentyone/images/2023/arrowdown.png" style="margin-top: 10px; margin-left: 70px; position: absolute;"></h1> 
        <div class="frame">
            <div class="carousel">
