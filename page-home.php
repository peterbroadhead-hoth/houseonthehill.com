...
<div class="home">
      ...
      <div class="text">  
        ...
        <div class="signup-buttons">
          <!--<form action="https://house-on-the-hill.com/mothership/supisacs.dll" method="POST" id="theForm" name="theForm" onsubmit="return Form_Validator(this);" enctype="multipart/form-data">
            ...
            <input type="HIDDEN" id="CFID" name="CFID" value="eJxTclXSUUJD4YmZJZl56cpGpnAhx7z8PCBlaKZvYKlvZGBkCOKYWhkYo2mFqgMiC0NLI0yjIQhojKEBujEGegYGQMoEJGSIRR4ZGaBht8yi4hIFn8y8VLgSI0MCToUgXUNMMZipRCKow7G7TNcSCBDmoRtrgM4CB4EFgm9sAnWgZ4hCcGpRWWZyqoJvYl5iempual4JuQ7HsBaEGACQ+Fww">
          ...
          <!--<a style="width: 290px;" target="_blank" class="g-cloud" href="https://www.digitalmarketplace.service.gov.uk/g-cloud/search?q=House-on-the-Hill&lot=cloud-software" rel="noopener">
            ...
            <span>GOV.UK Digital Marketplace</span>
          </a>-->
  ...
  <div class="solutions">
    <ul>
      <div class="text">
        <h2 style="color: white;">How can you use House-on-the-Hill?</h2>
        <p style="color: white;">Pick the perfect Help Desk solution to improve your customer experience or internal use.</p>
      </div>
      <li class="foi">
  ...
  <div class="large-features">
    <ul>
      <div class="text">
        <h2 style="color:white">Handpicked features we think you'd love</h2>
      </div>
      <li>
        <div class="img"><img src="https://hoth.local/wp-content/themes/houseonthehill.com/images/screenshots/hoth-portal.webp" alt="custom hoth portal" /></div>
        <div class="text">
          <h4>Branded Self-Service</h4>
      ...
      <li>
        <div class="img"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/screenshots/workflow&automation.webp" alt="FOI software quick report"></div>
        <div class="text">
      ...
      <!--<li>
        <div class="text">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/email-ticketing.webp" alt="branded self service portal">
      ...
      <li>
        <div class="img"><img src="/wp-content/themes/houseonthehill.com/images/screenshots/dragdropdashbuilder.webp" alt="drag and drop"></div>
        <div class="text">
          <h4>Custom Dashboards & Reports</h4>
  ...
  <div class="help">
    <div class="container">
      <ul>
        <li>
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/22icons/headset.webp" alt="hoth support icon">
