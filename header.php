	...
	<div class="hoth-header">
		...
		<div class="sales">
			<ul>
				...
				<div class="reveal">
					<p><strong>Want a personal HotH tour?</strong> <br><br>Email us at <a href="mailto:demo@houseonthehill.com" target="_blank" rel="noopener noreferrer">demo@houseonthehill.com</a> or sign in this quick form</p>
					<div class="form">
