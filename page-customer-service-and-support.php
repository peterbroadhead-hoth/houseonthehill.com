  ...
  <div class="header">
    <div class="container">  
      <div class="text">  
        ...
        <div class="img"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/22icons/original/csm-header.png" alt="csm graphic"></div>
    </div>
  </div>

  <div class="testimonials">
    <div class="testimonials-container"> 
      <h3>"The team at House-on-the-Hill are doing a great job at assisting the integration of the service desk and sorting out all the question and changes."</h3>
      <p>Allan Andrews,<strong> BBraun Australia Pty Ltd</strong></p>
